                ...
                if scores[0, index] > 0.8:
                    ...
                    if len(isim)==2:
                        ...
                        for i in range(2):
                            ...
                            b=b+1
                        if (name1=="b'insan'" and name2=="b'canta'"):
                            cv2.circle(image_np, (axort[1], ayort[1]), 10, (0, 0, 255), 5)
                            cv2.circle(image_np, (axort[0], ayort[0]), 10, (255, 0, 0), 5)
                            print('\nx Ekseni Mesafesi: ', abs(axort[0] - axort[1]))
                            print('y Ekseni Mesafesi: ', abs(ayort[0] - ayort[1]))
                            # img_name = "Hedef.jpeg"
                            # cv2.imwrite(img_name, image_np)
                            # start = time.time()
                            #bot.send_message(chatid, "y Ekseni Mesafesi: %d", (ayort[0] - ayort[1]))
                        ...
                        elif (name2=="b'insan'" and name1=="b'canta'"):
                            cv2.circle(image_np, (axort[0], ayort[0]), 10, (0, 0, 255), 5)

                            cv2.circle(image_np, (axort[1], ayort[1]), 10, (255, 0, 0), 5)
