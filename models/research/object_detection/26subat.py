                ...
                if scores[0, index] > 0.8:
                    ...
                    if (len(isim)==3 and len(isim)!=4):
                        ...
                        if ((name1==name3=="b'insan'" and name2=="b'canta'") and (mesafe10 > mesafe12)):
                            ...
                            j = j + 1
                            if (j>5):
                                if ((sonuc_1[j-1]>0 and sonuc_1[j-4]<0)):
                                     if(sonuc_1[j-2]>0 and sonuc_1[j-3]<0):
                                        print("j-1>0 ve j-4 <0 el değişimi oldu -----jjjjj+++++")
                                if ((sonuc_1[j-1]<0 and sonuc_1[j-4]>0)):   
                                     if(sonuc_1[j-2]<0 and sonuc_1[j-3]>0):
                                        print("j-1<0 ve j-4 >0 el değişimi oldu +++++jjjjj-----")
                           ...
                           # print(sonuc_2[k])
                            ...
                            k = k + 1
                            if (k>5):
                                if ((sonuc_2[k-1]>0 and sonuc_2[k-4]<0)):
                                     if(sonuc_2[k-2]>0 and sonuc_2[k-3]<0):
                                        print("k-1>0 ve k-4 <0 el değişimi oldu -----kkkkk+++++")
                                if ((sonuc_2[k-1]<0 and sonuc_2[k-4]>0)):   
                                     if(sonuc_2[k-2]<0 and sonuc_2[k-3]>0):
                                        print("k-1<0 ve k-4 >0 el değişimi oldu +++++kkkkk-----")
                            ...
                            if (k>5):
                                if ((sonuc_2[k-1]>0 and sonuc_2[k-4]<0)):
                                     if(sonuc_2[k-2]>0 and sonuc_2[k-3]<0):
                                        print("k-1>0 ve k-2 <0 el değişimi oldu -----kkkkk+++++")
                                if ((sonuc_2[k-1]<0 and sonuc_2[k-4]>0)):   
                                     if(sonuc_2[k-2]<0 and sonuc_2[k-3]>0):
                                        print("k-1<0 ve k-4 >0 el değişimi oldu +++++kkkkk-----")
                            ...
                            l = l + 1
                            if (l>5):
                                if ((sonuc_3[l-1]>0 and sonuc_3[l-4]<0)):
                                     if(sonuc_3[l-2]>0 and sonuc_3[l-3]<0):
                                        print("l-1>0 ve l-2 <0 el değişimi oldu -----lllll+++++")
                                if ((sonuc_3[l-1]<0 and sonuc_3[l-4]>0)):   
                                     if(sonuc_3[l-2]<0 and sonuc_3[l-3]>0):
                                        print("l-1<0 ve l-4 >0 el değişimi oldu +++++lllll-----")
                            ...
                            if (l>5):
                                ...
                                if ((sonuc_3[l-1]<0 and sonuc_3[l-4]>0)):   
                                     if(sonuc_3[l-2]<0 and sonuc_3[l-3]>0):
                                        print("l-1<0 ve l-4 >0 el değişimi oldu +++++lllll-----")
                    elif(len(isim)==2 and len(isim)!=3):
                        sonuc_1[j-1] = 0
                        sonuc_2[k-1] = 0
                        sonuc_3[l-1] = 0
                        print("else")
