                ...
                if scores[0, index] > 0.8:
                    ...
                    if (len(isim) == 3 and len(isim) != 4):
                        ...
                        if ((obje0 == obje2 == "b'person'" and obje1 == "b'bag'") and (mesafe10 > mesafe12)):
                            ...
                            j = j + 1
                            if (j > 1):
                                if (((sonuc_1[j - 1] > 0 and sonuc_1[j - 2] < 0)) or (
                                (sonuc_1[j - 1] < 0 and sonuc_1[j - 2] > 0))):
                                    print("TEHLİKEEEEE")

                        elif ((obje0 == obje2 == "b'person'" and obje1 == "b'bag'") and (mesafe10 < mesafe12)):
                            ...
                            k = k + 1
                            if (k > 1):
                                if (((sonuc_2[k - 1] > 0 and sonuc_2[k - 2] < 0)) or (
                                (sonuc_2[k - 1] < 0 and sonuc_2[k - 2] > 0))):
                                    print("TEHLİKEEEEE")
                            ...
                            l = l + 1
                            if (l > 1):
                                if (((sonuc_3[l - 1] > 0 and sonuc_3[l - 2] < 0)) or (
                                (sonuc_3[l - 1] < 0 and sonuc_3[l - 2] > 0))):
                                    print("TEHLİKEEEEE")
                    ...
                    if (len(isim) == 4 and len(isim) != 5):
                        ...
                        if ((obje0 == obje2 == obje3 == "b'person'" and obje1 == "b'bag'") and (
                                mesafe31 >= mesafe10 > mesafe12)):
                        ...
                        elif ((obje0 == obje2 == obje3 == "b'person'" and obje1 == "b'bag'") and (
                                mesafe31 >= mesafe12 > mesafe10)):
                            # print("canta name1e yakin")
                            cv2.circle(image_np, (axort[1], ayort[1]), 10, (0, 0, 255), 5)
                            sonuc_1[j] = int(mesafe10 - mesafe12)
                            j = j + 1
                            if (j > 1):
                                ...
                                mesafe12 >= mesafe31 > mesafe10)):
                            # print("canta name1e yakin")
                            cv2.circle(image_np, (axort[1], ayort[1]), 10, (0, 0, 255), 5)
                            sonuc_4[m] = int(mesafe10 - mesafe31)
                            m = m + 1
                            if (m > 1):
                                if (((sonuc_4[m - 1] > 0 and sonuc_4[m - 2] < 0)) or (
                                (sonuc_4[m - 1] < 0 and sonuc_4[m - 2] > 0))):
                                    print("TEHLİKEEEEE")

                        elif ((obje0 == obje2 == obje3 == "b'person'" and obje1 == "b'bag'") and (
                                mesafe12 >= mesafe10 > mesafe31)):
                            # print("canta name1e yakin")
                            cv2.circle(image_np, (axort[1], ayort[1]), 10, (0, 0, 255), 5)
                            sonuc_4[m] = int(mesafe10 - mesafe31)
                            m = m + 1
                        ...
                        elif ((obje1 == obje2 == obje3 == "b'person'" and obje0 == "b'bag'") and (
                                mesafe30 >= mesafe10 > mesafe20)):
                            cv2.circle(image_np, (axort[0], ayort[0]), 10, (0, 0, 255), 5)
                            sonuc_2[k] = int(mesafe10 - mesafe20)
                            k = k + 1
                            if (k > 1):
                            ...
                            if (k > 1):
                                ...
                                mesafe10 >= mesafe30 > mesafe20)):
                            cv2.circle(image_np, (axort[0], ayort[0]), 10, (0, 0, 255), 5)
                            sonuc_5[n] = int(mesafe30 - mesafe20)
                            n = n + 1
                            if (n > 2):
                                if (((sonuc_5[n - 1] > 0 and sonuc_5[n - 2] < 0)) or (
                                (sonuc_5[n - 1] < 0 and sonuc_5[n - 2] > 0))):
                                    print("TEHLİKEEEEE")

                        elif ((obje1 == obje2 == obje3 == "b'person'" and obje0 == "b'bag'") and (
                                mesafe10 >= mesafe20 > mesafe30)):
                            cv2.circle(image_np, (axort[0], ayort[0]), 10, (0, 0, 255), 5)
                            sonuc_5[n] = int(mesafe30 - mesafe20)
                            n = n + 1
                            if (n > 1):
                        ...
                        elif ((obje1 == obje0 == obje3 == "b'person'" and obje2 == "b'bag'") and (
                                mesafe32 >= mesafe12 > mesafe20)):
                            cv2.circle(image_np, (axort[2], ayort[2]), 10, (0, 0, 255), 10)
                            sonuc_3[l] = int(mesafe12 - mesafe20)
                            l = l + 1
                            if (l > 1):
                            ...
                            if (l > 1):
                                ...
                                mesafe12 >= mesafe32 > mesafe20)):
                            cv2.circle(image_np, (axort[2], ayort[2]), 10, (0, 0, 255), 10)
                            sonuc_6[o] = int(mesafe32 - mesafe20)
                            o = o + 1
                            if (o > 1):
                                if (((sonuc_6[o - 1] > 0 and sonuc_6[o - 2] < 0)) or (
                                (sonuc_6[o - 1] < 0 and sonuc_6[o - 2] > 0))):
                                    print("TEHLİKEEEEE")



                        elif ((obje1 == obje0 == obje3 == "b'person'" and obje2 == "b'bag'") and (
                                mesafe12 >= mesafe20 > mesafe32)):
                            cv2.circle(image_np, (axort[2], ayort[2]), 10, (0, 0, 255), 10)
                            sonuc_6[o] = int(mesafe32 - mesafe20)
                            o = o + 1
                            if (o > 1):
                                ...
                                mesafe31 >= mesafe30 > mesafe32)):
                            cv2.circle(image_np, (axort[3], ayort[3]), 10, (0, 0, 255), 10)
                            sonuc_7[p] = int(mesafe30 - mesafe32)
                            p = p + 1
                            if (p > 1):
                                if (((sonuc_7[p - 1] > 0 and sonuc_7[p - 2] < 0)) or (
                                (sonuc_7[p - 1] < 0 and sonuc_7[p - 2] > 0))):
                                    print("TEHLİKEEEEE")

                        elif ((obje1 == obje0 == obje2 == "b'person'" and obje3 == "b'bag'") and (
                                mesafe31 >= mesafe32 > mesafe30)):
                            cv2.circle(image_np, (axort[3], ayort[3]), 10, (0, 0, 255), 10)
                            sonuc_7[p] = int(mesafe30 - mesafe32)
                            l = l + 1
                            p = p + 1
                            ...
                            r = r + 1
                            if (r > 1):
                                if (((sonuc_8[r - 1] > 0 and sonuc_8[r - 2] < 0)) or (
                                (sonuc_8[r - 1] < 0 and sonuc_8[r - 2] > 0))):
                                    print("TEHLİKEEEEE")
                            ...
                            s = s + 1
                            if (s > 1):
                                if (((sonuc_9[s - 1] > 0 and sonuc_9[s - 2] < 0)) or (
                                (sonuc_9[s - 1] < 0 and sonuc_9[s - 2] > 0))):
                                    print("TEHLİKEEEEE")
