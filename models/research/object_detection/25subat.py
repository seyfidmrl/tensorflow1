                ...
                if scores[0, index] > 0.8:
                    ...
                    if (len(isim)==3 and len(isim)!=4):
                        ...
                        if ((name1==name3=="b'insan'" and name2=="b'canta'") and (mesafe10 > mesafe12)):
                            ...
                            j = j + 1
                            if (j>6):
                                if ((sonuc_1[j-1]>0 and sonuc_1[j-2]<0)):
                                     if(sonuc_1[j]>0 and sonuc_1[j-3]<0):
                                        print("j-1>0 ve j-2 <0 el değişimi oldu -----jjjjj+++++")
                                if ((sonuc_1[j-1]<0 and sonuc_1[j-2]>0)):   
                                     if(sonuc_1[j]<0 and sonuc_1[j-3]>0):
                                        print("j-1<0 ve j-2 >0 el değişimi oldu +++++jjjjj-----")
                           ...
                           # print(sonuc_2[k])
                            ...
                            k = k + 1
                            if (k>6):
                                if ((sonuc_2[k-1]>0 and sonuc_2[k-2]<0)):
                                     if(sonuc_2[k]>0 and sonuc_2[k-3]<0):
                            ...
                            l = l + 1
                            if (l>6):
                                if ((sonuc_3[l-1]>0 and sonuc_3[l-2]<0)):
                                     if(sonuc_3[l]>0 and sonuc_3[l-3]<0):
