                ...
                if scores[0, index] > 0.5:
                    ...
                    if len(isim)==3:
                        ...
                        for i in range(3):
                            ...
                            #print(isim[b], axort[b], ayort[b])
                            b=b+1
                        if (name1==name2=="b'insan'" and name3=="b'canta'"):
                    
                            print ('\nCanta 3 de')
                            print(isim[0], axort[0], ayort[0])
                            print(isim[1], axort[1], ayort[1])
                            print(isim[2], axort[2], ayort[2])
                            if (axort[2] - 50 < axort[0] < axort[2] + 50) or (axort[2] - 50 < axort[1] < axort[2] + 50):
                                print("cok yakin")
                            """mg_name = "Hedef.jpeg"
                        ...
                        elif (name1==name3=="b'insan'" and name2=="b'canta'"):
                            print('\nCanta 2 de')
                            print(isim[0], axort[0], ayort[0])
                            print(isim[1], axort[1], ayort[1])
                            print(isim[2], axort[2], ayort[2])
                            if (axort[1]-50<axort[0]<axort[1]+50) or (axort[1]-50<axort[2]<axort[1]+50):
                                print("cok yakin")
                            ...
                            print(isim[1], axort[1], ayort[1])
                            print(isim[2], axort[2], ayort[2])
                            if (axort[0]-50<axort[1]<axort[0]+50) or (axort[0]-50<axort[2]<axort[0]+50):
                                print("cok yakin")
