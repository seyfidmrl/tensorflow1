                ...
                if scores[0, index] > 0.8:
                        ...
                        if ((obje0==obje2=="b'person'" and obje1=="b'bag'") and (mesafe10 > mesafe12)):
                            ...
                            if (j > 3):
                                if (((sonuc_1[j - 1] > 0 and sonuc_1[j - 2] < 0)) or ((sonuc_1[j - 1] < 0 and sonuc_1[j - 2] > 0))):
                                    ...
                                    tarih = datetime.now()
                                    dt_string=tarih.strftime("%d-%m-%Y__%H-%M-%S")
                                    img_name = "deneme/"+ dt_string + ".jpg"
                    ...
                    if (len(isim) == 4 and len(isim) != 5):
                        ...
                        if ((obje0 == obje2 == obje3== "b'person'" and obje1 == "b'bag'") and (mesafe31>=mesafe10 > mesafe12)):
                            ...
                            m = m + 1
                            if (m > 3):
                                if (((sonuc_4[m - 1] > 0 and sonuc_4[m - 2] < 0)) or ((sonuc_4[m - 1] < 0 and sonuc_4[m - 2] > 0))):
                                    tarih = datetime.now()
                                    dt_string=tarih.strftime("%d-%m-%Y__%H-%M-%S")
                                    img_name = "deneme/"+ dt_string + ".jpg"
                                    cv2.imwrite(img_name, image_np)
                            ...
                            n = n + 1
                            if (n > 3):
                                if (((sonuc_5[n - 1] > 0 and sonuc_5[n - 2] < 0)) or ((sonuc_5[n - 1] < 0 and sonuc_5[n - 2] > 0))):
                                    tarih = datetime.now()
                                    dt_string=tarih.strftime("%d-%m-%Y__%H-%M-%S")
                                    img_name = "deneme/"+ dt_string + ".jpg"
                                    cv2.imwrite(img_name, image_np)
                            ...
                            o = o + 1
                            if (o > 3):
                                if (((sonuc_6[o - 1] > 0 and sonuc_6[o - 2] < 0)) or ((sonuc_6[o - 1] < 0 and sonuc_6[o - 2] > 0))):
                                    tarih = datetime.now()
                                    dt_string=tarih.strftime("%d-%m-%Y__%H-%M-%S")
                                    img_name = "deneme/"+ dt_string + ".jpg"
                                    cv2.imwrite(img_name, image_np)
